...
Section -post SEC0001
    ...
    #    WriteRegStr HKCR "bitcoin" "" "URL:DigitalNote"
    #    WriteRegStr HKCR "bitcoin\DefaultIcon" "" $INSTDIR\bitcoin-qt.exe
    #    WriteRegStr HKCR "bitcoin\DigitalNote\open\command" "" '"$INSTDIR\bitcoin-qt.exe" "$$1"'
SectionEnd
...
Section -un.post UNSEC0001
    ...
    #Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\DigitalNote.lnk"
    #Delete /REBOOTOK "$SMSTARTUP\DigitalNote.lnk"
